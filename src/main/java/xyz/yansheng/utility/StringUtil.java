...
public class StringUtil {
	 ...
	 * @author yansheng
	 * @version v1.0
	 * @date 2019-08-11 13:26:58
	 * @Description 从图片url中截取图片的精简的url（或者说是准确的url）
	 * @param picUrl 图片url
	 * @return   
	 * String 裁剪后的图片url
	 */
	 ...
	 * @author yansheng
	 * @version v1.0
	 * @date 2019-08-11 14:38:44
	 * @Description 替换文件夹字符串中特殊字符（\ / : * ? " < > | 英文的这些字符），使其能成功创建文件夹
	 * @param dirPath 文件夹字符串
	 * @return   
	 * String 替换后的文件夹字符串
	 */
	 ...
	 * <font color="red"><b>注意：<b>关于“加上".jpg"后缀”这个行为，这里可能会出现一个误区：这里只是简单地将图片进行重命名，
	 * 并没有改变图片的性质。就像你将一张图片GIF图片改后缀为jpg一样，它还是动图，而不是静态图。
	 * 这里添加后缀仅仅是为了能够让你的图片浏览器识别出来这是图片，不然没有后缀就识别不出来。</font>
	 * @param picName 图片文件名
	 * @return   
	 * String 处理后的图片文件名
	 */
